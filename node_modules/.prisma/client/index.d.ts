...
export namespace Prisma {
  ...
  */
    ...
    model: {
      mood: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.moodFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.moodAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type MoodMinAggregateOutputType = {
    ...
    name: string | null
    period: boolean | null
    scannedMood: string | null
    scannedStreak: number | null
    scannedSuggestion: string | null
    sleepEnd: Date | null
    sleepHours: number | null
  ...
  export type MoodCountAggregateOutputType = {
    ...
    period: number
    scannedMood: number
    scannedStreak: number
    scannedSuggestion: number
    sleepEnd: number
    sleepHours: number
    sleepStart: number
    social: number
  ...
  export type MoodGroupByOutputType = {
    id: string
    date: Date
    exercise: JsonValue | null
    hobby: JsonValue | null
    meal: JsonValue | null
    moodValue: string | null
    name: string
    period: boolean | null
  ...
  export type moodSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    period?: boolean
    scannedMood?: boolean
    scannedStreak?: boolean
    scannedSuggestion?: boolean
    sleepEnd?: boolean
    sleepHours?: boolean
    sleepStart?: boolean
    social?: boolean
  ...
  export type moodOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "date" | "exercise" | "hobby" | "meal" | "moodValue" | "name" | "period" | "scannedMood" | "scannedStreak" | "scannedSuggestion" | "sleepEnd" | "sleepHours" | "sleepStart" | "social" | "streak" | "suggestions" | "weather", ExtArgs["result"]["mood"]>
  ...
  export interface moodDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Moods that matches the filter.
     * @param {moodFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const mood = await prisma.mood.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: moodFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Mood.
     * @param {moodAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const mood = await prisma.mood.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: moodAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface moodFieldRefs {
    ...
    readonly exercise: FieldRef<"mood", 'Json'>
    readonly hobby: FieldRef<"mood", 'Json'>
    readonly meal: FieldRef<"mood", 'Json'>
    readonly moodValue: FieldRef<"mood", 'String'>
    readonly name: FieldRef<"mood", 'String'>
    readonly period: FieldRef<"mood", 'Boolean'>
    readonly scannedMood: FieldRef<"mood", 'String'>
    readonly scannedStreak: FieldRef<"mood", 'Int'>
    readonly scannedSuggestion: FieldRef<"mood", 'String'>
    readonly sleepEnd: FieldRef<"mood", 'DateTime'>
    readonly sleepHours: FieldRef<"mood", 'Float'>
    readonly sleepStart: FieldRef<"mood", 'DateTime'>
    readonly social: FieldRef<"mood", 'Json'>
    readonly streak: FieldRef<"mood", 'Int'>
    readonly suggestions: FieldRef<"mood", 'String'>
    readonly weather: FieldRef<"mood", 'Json'>
  }
   ...
   * mood findRaw
   */
  export type moodFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
   ...
   * mood aggregateRaw
   */
  export type moodAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export const MoodScalarFieldEnum: {
    ...
    name: 'name',
    period: 'period',
    scannedMood: 'scannedMood',
    scannedStreak: 'scannedStreak',
    scannedSuggestion: 'scannedSuggestion',
    sleepEnd: 'sleepEnd',
  ...
  export type moodWhereInput = {
    ...
    exercise?: JsonNullableFilter<"mood">
    hobby?: JsonNullableFilter<"mood">
    meal?: JsonNullableFilter<"mood">
    moodValue?: StringNullableFilter<"mood"> | string | null
    name?: StringFilter<"mood"> | string
    period?: BoolNullableFilter<"mood"> | boolean | null
    scannedMood?: StringNullableFilter<"mood"> | string | null
    scannedStreak?: IntFilter<"mood"> | number
    scannedSuggestion?: StringNullableFilter<"mood"> | string | null
    sleepEnd?: DateTimeNullableFilter<"mood"> | Date | string | null
    sleepHours?: FloatNullableFilter<"mood"> | number | null
    sleepStart?: DateTimeNullableFilter<"mood"> | Date | string | null
    social?: JsonNullableFilter<"mood">
    streak?: IntNullableFilter<"mood"> | number | null
    suggestions?: StringNullableFilter<"mood"> | string | null
    weather?: JsonNullableFilter<"mood">
  }
  ...
  export type moodOrderByWithRelationInput = {
    ...
    name?: SortOrder
    period?: SortOrder
    scannedMood?: SortOrder
    scannedStreak?: SortOrder
    scannedSuggestion?: SortOrder
    sleepEnd?: SortOrder
  ...
  export type moodScalarWhereWithAggregatesInput = {
    ...
    exercise?: JsonNullableWithAggregatesFilter<"mood">
    hobby?: JsonNullableWithAggregatesFilter<"mood">
    meal?: JsonNullableWithAggregatesFilter<"mood">
    moodValue?: StringNullableWithAggregatesFilter<"mood"> | string | null
    name?: StringWithAggregatesFilter<"mood"> | string
    period?: BoolNullableWithAggregatesFilter<"mood"> | boolean | null
    scannedMood?: StringNullableWithAggregatesFilter<"mood"> | string | null
    scannedStreak?: IntWithAggregatesFilter<"mood"> | number
    scannedSuggestion?: StringNullableWithAggregatesFilter<"mood"> | string | null
    sleepEnd?: DateTimeNullableWithAggregatesFilter<"mood"> | Date | string | null
    sleepHours?: FloatNullableWithAggregatesFilter<"mood"> | number | null
    sleepStart?: DateTimeNullableWithAggregatesFilter<"mood"> | Date | string | null
    social?: JsonNullableWithAggregatesFilter<"mood">
    streak?: IntNullableWithAggregatesFilter<"mood"> | number | null
    suggestions?: StringNullableWithAggregatesFilter<"mood"> | string | null
    weather?: JsonNullableWithAggregatesFilter<"mood">
  }

  export type moodCreateInput = {
    id?: string
    date: Date | string
    exercise?: InputJsonValue | null
    hobby?: InputJsonValue | null
    meal?: InputJsonValue | null
    moodValue?: string | null
    name: string
    period?: boolean | null
    scannedMood?: string | null
  ...
  export type moodUpdateInput = {
    ...
    exercise?: InputJsonValue | InputJsonValue | null
    hobby?: InputJsonValue | InputJsonValue | null
    meal?: InputJsonValue | InputJsonValue | null
    moodValue?: NullableStringFieldUpdateOperationsInput | string | null
    name?: StringFieldUpdateOperationsInput | string
    period?: NullableBoolFieldUpdateOperationsInput | boolean | null
    scannedMood?: NullableStringFieldUpdateOperationsInput | string | null
    scannedStreak?: IntFieldUpdateOperationsInput | number
    scannedSuggestion?: NullableStringFieldUpdateOperationsInput | string | null
    sleepEnd?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    sleepHours?: NullableFloatFieldUpdateOperationsInput | number | null
    sleepStart?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    social?: InputJsonValue | InputJsonValue | null
    streak?: NullableIntFieldUpdateOperationsInput | number | null
    suggestions?: NullableStringFieldUpdateOperationsInput | string | null
    weather?: InputJsonValue | InputJsonValue | null
  }
